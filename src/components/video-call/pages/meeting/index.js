...
const Meeting = (props) => {
  ...
  const optionsInit = () => {
    //console.log("parseInt(Cookies.get(channel)):::::", parseInt(Cookies.get("channel")));
    let options = {
      videoProfile: "480p_4",
      ...
      attendeeMode: "video",
      baseMode: "avc",
      displayMode: 1, // 0 Tile, 1 PIP, 2 screenCookies.get("microphoneId") share
      uid: 0, // In default it is dynamically generated
      resolution: undefined
    };

    let tempProfile = RESOLUTION_ARR[options.videoProfile];
    options.resolution = tempProfile[0] / tempProfile[1] || 4 / 3;

    options.key = APP_ID;
    //console.log("Cookies.get --agora_access_token :::::", Cookies.get("agora_access_token"));
    options.token = Cookies.get("agora_access_token");
  ...
  const clientInit = (client, options) => {
    // let token = "006fb838baf4c384f519acb2461aaf79b7aIADoCbl7TOXDTRgzxLMOkIUujR/Nb/eflYd25l7qfmM8GTLRTXgAAAAAEAC5X9YGG0tjYAEAAQAbS2Ng"
    // let channel = "Test"
